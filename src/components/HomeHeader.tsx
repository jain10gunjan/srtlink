...
<div className="bg-neutral-900">
  <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
    ...
    <div className="max-w-4xl">
      ...
      Transform long URLs into concise, memorable links that amplify your reach. Share your content effortlessly and make every click count. Our platform simplifies the process, ensuring your links are easy to share and track. Elevate your sharing game and connect faster with short, impactful links.
      </p> 
    </div>
  </div>
</div>
...
<div className="relative overflow-hidden pt-4 bg-neutral-900">
  ...
  <div className="relative z-10">
    <div className="max-w-5xl px-4 xl:px-0 mx-auto">
      <div className="mb-4">
        <h2 className="text-neutral-400">Trusted by Thousands.</h2>
      </div>
    </div>
  </div>
</div>
